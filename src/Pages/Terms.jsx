    ...
    <div className="AboutTerms">
      ...
      <div className="vision2030">
        ...
        <p>
          ...
          License"), such User Content License in any event to be limited,
          ...
          distribute the User Content over public networks and in media and (b)
          make available and sublicense the User Content to third parties for
          ...
          applicable law, the English language version takes precedence over any
          translation version.
          <br></br> <br></br>
          ...
          other person shall be a third party beneficiary to this Agreement.
          <br></br> <br></br>
