  ...
  const features = [
    {
      ...
      description: "The Geoportal platform enables the agency share spatial data and maps in diverse formats such as PDF, Shapefiles, KML, GeoJSON, and Web Services.",
      icon: <ExploreIcon sx={{ fontSize: 40, color: "primary.main" }} />
    },
    {
      title: "Data Analysis",
      description: "The platform provides several data analysis capabilities. Users can build simple to complex queries for the analysis of data attributes. The portal's search function allows query for specific data. Access to the Open Data Cube enables users analyse the Earth observation data.",
      icon: <AnalyticsIcon sx={{ fontSize: 40, color: "primary.main" }} />
    },
    {
      title: "Report Generation",
      description: "After perfoming their data analysis, users are able to generate a report of their interaction with the data automatically. The portal allows export generation of PFD reports from its available templates which users can edit and export.",
      icon: <ReportIcon sx={{ fontSize: 40, color: "primary.main" }} />
    },
    {
      title: "Download Data",
      description: "Users are able to download spatial data in different data formats. Data available to users ranges from thematic data, topographical maps, cadastral maps to aerial images and web services.",
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              >
                ...
                visualization (also known as GIS) capabilities.
              </Typography>
              <Typography
                variant="body1"
                sx={{
