        ...
        <Paper elevation={2} sx={{ p: 4 }}>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              the personal data Oakar Services Plc ("Oakar Services") collects,
              how Oakar Services processes it, and for what purposes.
            </Typography>
            <Typography variant="body1" paragraph>
              This statement should be read together with the Terms and
              Conditions of Use for other Oakar Services products and services.
              Where there is a conflict, this statement will prevail.
            </Typography>
            <Typography variant="body1" paragraph>
              This statement applies to all customers, suppliers, agents,
              merchants, dealers and all visitors frequenting any of Oakar
              Services premises.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              necessarily exhaustive and therefore the examples given are not
              the only things/situations included in the meaning or explanation
              of that text.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              We may use and analyse your information for the following
              purposes:
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              Categories of Personal Data as defined in the Data Protection Act
              of Kenya may be processed depending on the particular types of
            ...
            <Typography variant="body1" paragraph>
              ...
              lawful basis provided for under the Data Protection Law:
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              ...
              those purposes through other means, the need to comply with our
              internal policy and the applicable legal, regulatory, tax,
              accounting or other requirements. Anonymised information that can
              no longer be associated with you may be held indefinitely.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              applicable law and regulations. Oakar Services shall assess and
              review each application for information and may decline to grant
            ...
            <Typography variant="body1" paragraph>
              4.3 Some of your information may be passed on to any person whom
              ...
              Lipa Na M-PESA Merchants, mobile money interoperability partners,
              ATM Switch providers and vendors of the M-PESA money transfer
              technology platform.
            </Typography>

            <Typography variant="body1" paragraph>
              4.4 We shall not release any information to any individual or
              entity that is acting beyond its legal mandate.
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              4.6.1 You may be required to opt in or give any other form of
            ...
            <Typography variant="body1" paragraph>
              ...
              Agency.co.ke and checking or unchecking relevant boxes to adjust
              your marketing preferences or by following the optout links on any
              marketing message sent to you or by attending to us or contacting
              us at any time through the provided contacts.
            </Typography>
            <Typography variant="body1" paragraph>
              4.6.3 Where you opt out of receiving these marketing messages,
              this will not apply to personal data provided to us as a result of
              a product, service already taken up, warranty registration,
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              5.1 We may store some information (using "cookies") on your
              ...
              non-personal (such as: the Internet Protocol (IP) address of your
              computer, the date and time of your visit, which pages you browsed
              and whether the pages have been delivered successfully.
            </Typography>
            <Typography variant="body1" paragraph>
              5.2 We may also use this data in aggregate form to develop
              ...
              cookies, or to prevent your browser from accepting any cookies at
              all. This will however cause certain features of the web site not
              to be accessible.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              6.1 Our websites may provide hyperlinks to other locations or
              websites on the Internet. These hyperlinks lead to websites
              published or operated by third parties who are not affiliated with
              or in any way related to us and have been included in our website
              to enhance your user experience and are presented for information
              purposes only.
            </Typography>
            <Typography variant="body1" paragraph>
              ...
              website or webpage and do not have any co-operation with such
              third parties unless otherwise disclosed. We are not in any way
              responsible for the content of any externally linked website or
              webpage.
            </Typography>
            <Typography variant="body1" paragraph>
              ...
              privacy and cookie policies of the other website that you choose
              to visit.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              <Link
                href="https://selfcare.Kenya Space Agency.co.ke/"
                target="_blank"
              >
                https://selfcare.Kenya Space Agency.co.ke/
              </Link>{" "}
              and sign in to my Oakar Services self-care to look at your
              personal information. You can change how we get in touch with you
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              Oakar Services has put in place technical and operational measures
              to ensure integrity and confidentiality of your data via controls
              around: information classification, access control, cryptography,
              physical and environmental security and monitoring and compliance.
            </Typography>
          </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              From time to time we may need to transfer your personal
              information outside the Republic of Kenya.
            </Typography>
            <Typography variant="body1" paragraph>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              contact us on{" "}
              <Link href="mailto:dpo@OakarServices.co.ke">
                dpo@OakarServices.co.ke
              </Link>
